      ...
      <div className="min-h-screen bg-gray-50 py-8 mt-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <img src={pigFarmingImage} alt="सुअर पालन प्रशिक्षण" className="w-full h-64 object-cover" />
            <div className="p-6">
              <h1 className="text-3xl font-bold text-gray-900 mb-4">सुअर पालन प्रशिक्षण</h1>
              <p className="text-gray-700 mb-4">सुअर पालन, स्वास्थ्य और विपणन।</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-gray-50 p-4 rounded">
                  ...
                  <p className="text-gray-700">रवि शर्मा</p>
                </div>
                <div className="bg-gray-50 p-4 rounded">
                  <h3 className="font-semibold text-gray-900">
                    {t('trainings.fee')}
